...
// Insert many bags
router.post('/insert-bags', historyLogger('bags'), bagsController.insertManyBags);

// Update many bags
router.post('/update-many-bags', historyLogger('bags'), bagsController.updateManyBags);

// Update single bags
router.patch('/update-bags/:id', historyLogger('bags'), bagsController.updateBags);
