...
describe('Reactive Product Name Synchronization Integration Tests', () => {
    let mongoServer;
    let stockId1, stockId2, colorId1, colorId2;
    ...
    beforeEach(async () => {
        ...
        const stockResponse = await request(app)
            ...
            .send([
                { Tow_Kod: 'STOCK001', Tow_Opis: 'Original Stock Name' },
                { Tow_Kod: 'STOCK002', Tow_Opis: 'Second Stock' }
            ]);
        stockId1 = stockResponse.body.stocks[0]._id;
        stockId2 = stockResponse.body.stocks[1]._id;
