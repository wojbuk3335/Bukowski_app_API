...
const Bags = () => {
    ...
    const addNewRow = async () => {
        try {
            ...
            await axios.post('/api/excel/bags-category/insert-many-bags-categories', [newCategory]);
    ...
    const handleUpdateSubmit = async () => {
        try {
            ...
            await axios.patch(`/api/excel/bags-category/update-bags-category/${currentBagCategory._id}`, { 
    ...
    const getBagCategoryList = async () => {
        const categoryResponse = (await axios.get(`/api/excel/bags-category/get-all-bags-categories`)).data;
